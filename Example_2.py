...
if __name__ == '__main__':
    ...
    file_target = file_list[menu(
        file_list, "What file do you want to operate on? ")]
    operation_list = ["Find pages with IPs"]
    operation = menu(
        operation_list, "What operation would you proform on the file? ")
